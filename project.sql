...
(1, '2022-04-01', '2022-04-10', '2022-04-15', '20:00:00', 5, 0, 350, 2),
...
(8, '2022-04-21', '2022-04-23', '2022-04-26', '20:17:00', 2, 3, 200, 2),
(9, '2022-04-22', '2022-04-27', '2022-04-29', '17:45:00', 5, 2, 250, 15),
(11, '2022-04-23', '2022-04-30', '2022-05-05', '18:00:00', 6, 3, 250, 15),
(12, '2022-04-13', '2022-04-16', '2022-04-19', '17:30:00', 4, 3, 200, 2),
...
(2, 'NINI 尼尼義大利餐廳', 'NINI@test.com', '222', '03-222-3271', '桃園市蘆竹區南崁路一段112號', 'NINI《NATURAL自然、INITIAL獨創、NEAT純淨、IMPRESSIVE感動》我們相信用好的食材與料理方式，就能對自我和環境產生正向的改變；透過好的用餐環境，讓顧客們和我們一樣愛上這樣的生活方式。', 'NINI.jpg', '3', '1', '2022-04-21', 0),
...
(15, '肯德基 桃園中山二餐廳', 'kfcclub@test.com', '1515', '03-336-0860', '330桃園市桃園區中山路444號446號', '肯德基是源自美國的速食連鎖店， 總部設於肯塔基州路易維爾市，以炸雞為主力產品。', 'kfc.jpg', '8', '1', '2022-04-26', 1);
...
--
ALTER TABLE `groups`
  MODIFY `groups_id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
