...
-- 資料表結構 `coupon`
--
-- 建立時間： 2022 年 04 月 22 日 17:01
-- 最後更新： 2022 年 04 月 22 日 18:25
--
...
(1, '鑽石會員獨享優惠', 200, '2022-04-22'),
(2, '綠寶石會員，新用戶好禮', 50, '2022-04-22');
...
(1, '村民食堂', 'villager@test.com', '111', '111', '03-339-868', '桃園市桃園區中正路1078號', '無距離享受與自然和諧共處，讓每個人在繁忙之餘，\r\n也能擁有輕鬆的步調，與家人朋友相聚用餐，共享歡樂！', 'Villager.jpg', '2', '1', '2022-04-22', 1),
(2, 'NINI 尼尼義大利餐廳', 'NINI@test.com', '222', '222', '03-222-3272', '桃園市蘆竹區南崁路一段112號', 'NINI《NATURAL自然、INITIAL獨創、NEAT純淨、IMPRESSIVE感動》\r\n我們相信用好的食材與料理方式，就能對自我和環境產生正向的改變；\r\n透過好的用餐環境，讓顧客們和我們一樣愛上這樣的生活方式。', 'NINI.jpg', '3', '1', '2022-04-21', 1),
(3, '梳子．Salud', 'Salud@test.com', '333', '333', '02-2711-8832', '330桃園市桃園區新埔六街89', '由川門子團隊帶來，\r\n西班牙式的Tapas碰上川式料理\r\n蹦出！精緻美味小餐點！\r\n搭配無毒生菜、德國有機農莊，\r\n希望提供給您一個全新體驗的蔬食。\r\n自然的用餐環境，讓您留下美好的身影：）', 'Salud.jpg', '1', '1', '2022-04-23', 1),
...
--
ALTER TABLE `user_and_coupon`
  MODIFY `user_and_coupon_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
